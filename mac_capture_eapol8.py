...
# Check for 32H9F_5G frames (full MAC)
print("=== Check for 32H9F_5G frames ===")
shell = client.invoke_shell()
time.sleep(2)
shell.send('/usr/local/bin/tshark -r ~/all_frames.pcap -Y "wlan.sa == 6c:4f:89:4c:a0:e4" 2>&1 | head -20\n')
time.sleep(5)
...
# Check for EAPOL frames (full MAC)
