...
# Try with sudo -E (preserve environment)
print("=== airodump-ng en0 (sudo -E, space) ===")
shell = client.invoke_shell()
time.sleep(2)
shell.send("sudo -E -S /usr/local/Cellar/aircrack-ng/1.7_2/sbin/airodump-ng en0 2>&1 | head -40\n")
time.sleep(3)
shell.send(" \n")  # Space
time.sleep(15)
