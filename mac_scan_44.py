...
# Try tshark with linktype 105 (802.11)
print("=== tshark -i en0 -I -y 105 (sudo space) ===")
shell = client.invoke_shell()
time.sleep(2)
shell.send("sudo -S /usr/local/bin/tshark -i en0 -I -y 105 -c 100 -w /tmp/test6.pcap 2>&1\n")
time.sleep(3)
shell.send(" \n")  # Space
time.sleep(15)
