...
# Try tshark with linktype 113 (802.11-PRISM)
print("=== tshark -i en0 -I -y 113 (sudo space) ===")
shell = client.invoke_shell()
time.sleep(2)
shell.send("sudo -S /usr/local/bin/tshark -i en0 -I -y 113 -c 100 -w /tmp/test7.pcap 2>&1\n")
time.sleep(3)
shell.send(" \n")  # Space
time.sleep(15)
