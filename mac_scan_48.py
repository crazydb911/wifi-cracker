...
# Try tshark with IEEE802_11 linktype
print("=== tshark -i en0 -I -y IEEE802_11 (sudo space) ===")
shell = client.invoke_shell()
time.sleep(2)
shell.send("sudo -S /usr/local/bin/tshark -i en0 -I -y IEEE802_11 -c 100 -w /tmp/test8.pcap 2>&1\n")
time.sleep(3)
shell.send(" \n")  # Space
time.sleep(15)
