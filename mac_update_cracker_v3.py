#!/usr/bin/env python3
"""
Mac WiFi Cracker v3 - Uses airodump-ng from Cellar path.
"""
...
app = FastAPI(title="Mac WiFi Cracker v3")
...
def scan_wifi():
    """Use airodump-ng from Cellar path."""
...
<html>
<head>
    <title>Mac WiFi Cracker v3</title>
    <style>
...
if __name__ == "__main__":
    log("Starting Mac WiFi Cracker v3 on port 8765...")
